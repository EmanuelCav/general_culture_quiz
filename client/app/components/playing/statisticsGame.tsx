...
const StatisticsGame = ({ seconds, minutes, setSeconds, setMinutes, setTotalSeconds, totalSeconds, numberQuestion, questions, realSeconds, realMinutes, isCorrect, isIncorrect, isFinish, isPreFinish }: StatisticsGamePropsType) => {
    return (
